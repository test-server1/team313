  ...
  function ScrollSmoother(t) {
      ...
      ;(Aa(),
        ...
        b &&
          (b.forEach(function (e) {
            var t = e.start,
              r = e.auto
                ? Math.min(V.maxScroll(e.scroller), e.end)
                : t + (e.end - t) / e.ratio,
              n = (r - e.end) / 2
            ;((t -= n),
              (r -= n),
              ...
              onUpdate: function onUpdate(e) {
                ...
                if (e.offset) {
                  ...
                  ;((o = (function _round(e) {
                    ...
                    l
                      ? (l.resetTo('y', o, -A, !0), F && l.progress(1))
    ...
    ;(Ka(),
      ...
      (this.scrollTo = function (e, t, r) {
        ...
        t
          ? u
            ? D.to(o, { duration: k, scrollTop: n, overwrite: 'auto', ease: Y })
            : R(n)
          : Ea(n)
      }),
        ...
        if (arguments.length) {
          ...
          return (
            t !== n &&
              ...
              k || D.set(n, { clearProps: 'transform' })),
            this
          )
        }
        return n
    ...
    ;(B.forEach(function (e) {
      ...
      (this.smooth = function (e) {
        return (
          arguments.length &&
            ((_ = ((k = e || 0) && +t.speed) || 1), i.scrubDuration(e)),
      ...
      (this.kill = this.revert =
        function () {
          ...
          ;(V.scrollerProxy(S),
            ...
            (n.style.cssText = c))
          var r = V.defaults({})
          ;(r && r.scroller === S && V.defaults({ scroller: O }),
      ...
      E &&
        (this.normalizer = V.normalizeScroll(
          !0 === E ? { debounce: !0, content: !k && n } : E,
        )),
      V.config(t),
      'overscrollBehavior' in O.getComputedStyle(J) &&
        D.set([J, U], { overscrollBehavior: 'none' }),
      'scrollBehavior' in O.getComputedStyle(J) &&
        D.set([J, U], { scrollBehavior: 'auto' }),
