          ...
          (i.update = function (e, t) {
            ...
            for (var f = 0; f < e.parts.length; f++) {
              ...
              ;(o.translate(v.vertices, e.velocity),
                ...
                0 !== e.angularVelocity &&
                  (o.rotate(v.vertices, e.angularVelocity, e.position),
    ...
    function (e, t, n) {
      ...
      ;((o = []),
        ...
        (i.collides = function (e, t, n) {
          if (
            (i._overlapAxes(r, e.vertices, t.vertices, e.axes), r.overlap <= 0)
          )
            return null
          if (
            (i._overlapAxes(a, t.vertices, e.vertices, t.axes), a.overlap <= 0)
          )
            return null
          var o,
            c,
        ...
        (i._findSupports = function (e, t, n, i) {
          ...
          for (c = 0; c < d; c += 1)
            (l = v * (p - (a = u[c]).x) + y * (f - a.y)) < m &&
              ((m = l), (r = a))
          return (
            (m = v * (p - (s = u[(d + r.index - 1) % d]).x) + y * (f - s.y)),
          ...
          ;((e.isActive = !0),
            ...
            (e.frictionStatic =
              s.frictionStatic > l.frictionStatic
                ...
                : l.frictionStatic),
            (e.restitution =
              s.restitution > l.restitution ? s.restitution : l.restitution),
          ...
          if (n || o) {
            ...
            if (
              ...
              var p,
                ...
                w =
                  S + ((n ? n.inverseInertia : 0) + (o ? o.inverseInertia : 0))
              if (h > 0) {
                var A = r.create()
                ;((v = r.div(u, d)),
                  (m = r.sub(
    ...
    function (e, t, n) {
      ...
      ;((i.create = function (e) {
        ...
        (i.update = function (e, t) {
          ...
          for (r.preSolvePosition(y.list), n = 0; n < e.positionIterations; n++)
              ...
              for (n = 0; n < a; n++) {
                ...
                if (0 !== v || 0 !== y) {
                  ...
                  ;(l.isStatic ||
                    ...
                    (l.anglePrev +=
                      l.inverseInertia *
                      ((f.x - l.position.x) * g - (f.y - l.position.y) * m))),
                    c.isStatic ||
                      c.isSleeping ||
                      ...
                      (c.anglePrev -=
                        c.inverseInertia *
                        ((f.x - c.position.x) * g - (f.y - c.position.y) * m))))
                }
              }
            }
          }
            ...
            if (y.isActive && !y.isSensor) {
              ...
              for (
                ...
                var N = R * w - V * S,
                  ...
                  X =
                    B /
                    (_ + g.inverseInertia * N * N + x.inverseInertia * z * z),
                  Q = (1 + y.restitution) * j * X
                if (((n *= X), j < u)) I.normalImpulse = 0
                else {
          ...
          for (var c = e.bodies, u = 1; u < c.length; u++) {
            var d = c[u - 1],
              ...
              m = {
                ...
                pointA: { x: v * t, y: f * n },
                bodyB: p,
                pointB: { x: (p.bounds.max.x - p.bounds.min.x) * i, y: y * s },
              },
              g = a.extend(m, l)
        ...
        ;('undefined' != typeof window &&
          ...
          (i.world = function (e, t) {
            ...
            if (
              ...
              for (n = 0; n < h.length; n++) {
                ...
                ;(M && (_ = c.add(M.position, C.pointA)),
                  ...
                  _ &&
                    k &&
                    (s.contains(e.bounds, _) || s.contains(e.bounds, k)) &&
                    w.push(C))
              }
            ...
            ;(!m.wireframes || (d.enableSleeping && m.showSleeping)
              ? i.bodies(e, S, v)
              : (m.showConvexHulls && i.bodyConvexHulls(e, S, v),
          ...
          (i.status = function (e, t, n, i, o, a, s, l, c) {
            ;((e.strokeStyle = '#888'),
              ...
              e.beginPath(),
              e.moveTo(t, n + 7 - o * r.clamp(0.4 * c(0), -2, 2)))
            for (var u = 0; u < i; u += 1)
              e.lineTo(
                t + u,
                n + 7 - (u < a ? o * r.clamp(0.4 * c(u), -2, 2) : 0),
              )
            ;(e.stroke(),
              (e.fillStyle =
            ...
            for (var n = t, i = 0; i < e.length; i++) {
              ...
              if (o.render.visible && o.pointA && o.pointB) {
                var a,
                  ...
                  u = o.bodyB
                if (
                  ((a = l ? c.add(l.position, o.pointA) : o.pointA),
                  'pin' === o.render.type)
                )
                  (n.beginPath(),
                  ...
                  if (
                    ((s = u ? c.add(u.position, o.pointB) : o.pointB),
                    n.beginPath(),
                    n.moveTo(a.x, a.y),
                    ...
                    for (
                      var d,
                        ...
                        v = Math.ceil(r.clamp(o.length / 5, 12, 20)),
                        y = 1;
                      y < v;
                      y += 1
                    )
